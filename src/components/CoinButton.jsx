        ...
        <AnimatePresence>
            ...
            >
                <div className="relative flex flex-col">
                    <motion.div
                        className="w-96 h-72 mt-12 bg-white rounded-xl border-4 border-[#DC483A] shadow-lg relative bg-center"
                        initial={{ scale: 0 }}
                        animate={{ scale: 1.5 }}
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-6 text-gray-800 text-lg font-bold font-mono">
                            <div className="flex justify-between w-full">
                                <span>Gas Money:</span>
                                <span>APT {resp.userTransactionResponse.gas_used * resp.userTransactionResponse.gas_unit_price}</span>
                            </div>
                            <div className="flex justify-between w-full">
                            ...
                            <div className="flex justify-between w-full">
                                ...
                                <span>APT {resp.resource.coin.value}</span>
                            </div>
                            <button className="mt-6 w-fit mx-auto px-3 py-1 bg-[#ffcfcb] border-2 border-black text-xl  rounded-md hover:bg-[#DC483A] transition-all">
                                Okay, got it!
                            </button>
                        </div>
                    </motion.div>
